#ifndef GE_APP_SETTINGS_H
#define GE_APP_SETTINGS_H
...
// This will be the effective x resolution regardless of actual screen/window res
#define APP_VIRTUAL_WIDTH		(1024)

// This will be the effective y resolution regardless of actual screen/window res
